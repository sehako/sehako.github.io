...
![구글 OAuth 정보](/assets/images/development/spring/24-12-11-oauth-03/01.png)

**카카오**

![카카오 OAuth 정보](/assets/images/development/spring/24-12-11-oauth-03/02.png)

**데이터베이스**

![데이터베이스 사용자 값 확인](/assets/images/development/spring/24-12-11-oauth-03/03.png)
