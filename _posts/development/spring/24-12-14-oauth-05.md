...
![사용자 정보 요청](/assets/images/development/spring/24-12-14-oauth-05/01.png)

쿠키에 리프레시 토큰이 저장됐는지 살펴보자. 쿠키는 개발자 도구의 Application 탭에서 확인할 수 있다.

![리프레시 토큰 조회](/assets/images/development/spring/24-12-14-oauth-05/02.png)

## 엑세스 토큰 재발급

![엑세스 토큰 재발급](/assets/images/development/spring/24-12-14-oauth-05/03.png)
...
![로그아웃 처리](/assets/images/development/spring/24-12-14-oauth-05/04.png)
