...
트리역시 그래프의 형태 중 하나로, 순환이 없는 연결 그래프 구조를 띄는 것으로 이해하면 된다. 트리와 그래프의 차이를 나타내는 표를 첨부한다.

![그래프와 트리의 차이](/assets/images/graph-02.png)
...
<p align="center">
  <img src="/assets/images/graph-03.png" alt="무방향 그래프" width="30%" />
</p>
...
<p align="center">
  	<img src="/assets/images/graph-04.png" alt="방향 그래프" width="30%" />
</p>
