...
최근에 진행하는 프로젝트에서 처음 해보는 서버 배포와 CI/CD 부분을 맡았다. 따라서 이 포스팅은 인프라 입문이 막막한 사람들을 위해 인프라에 대해 하나도 몰랐던 내가 어떤 과정을 거쳤는 지에 대해서 작성하는 일련의 시리즈가 될 것이다. 그 첫 번째로 도커와 도커 컴포즈가 되겠다.
